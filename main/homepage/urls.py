...
urlpatterns = [
    ...
    path('students_list/', views.StudentListView.as_view(),
         name='students_list'),
    path('student/<pk>', views.DetailsStudentView.as_view(),
         name='student'),
    path('create_student/', views.CreateStudentView.as_view(),
         name='create_student'),
    path('edit_student/<pk>', views.EditStudentView.as_view(),
         name='edit_student'),
    path('delete_student/<pk>', views.DeleteStudentView.as_view(),
         name='delete_student'),
