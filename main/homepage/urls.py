...
urlpatterns = [
    ...
    path('subject/<id>', views.SubjectInfoView.as_view(), name='delete_subject'),
    path('subject/<id>', views.SubjectInfoView.as_view(), name='edit_subject_name'),
    path('subject/<id>', views.SubjectInfoView.as_view(), name='subject_info'),

    path('teachers', views.TeachersView.as_view(), name='teachers'),
    path('teacher/<id>', views.TeacherDetailView.as_view(), name='teacher_detail'),
    path('teacher/<id>', views.TeacherDetailView.as_view(), name='delete_teacher'),
    path('teacher/<id>', views.TeacherDetailView.as_view(), name='add_student'),
    path('teacher/<id>', views.TeacherDetailView.as_view(), name='edit_teachers_name'),
]
